<footer class="col-lg-12 col-md-12 col-sm-12 col-xs-12 bg-cinza-footer">
    <div class="container Relative">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 MarginT20p">
            <img src="imagens/Harpyja-logo.png" class="img-responsive" >
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 text-center MarginT15p">
            <h3>Lorem ipsum</h3>
            <h5>Lorem ipsum</h5>
            <h5>Lorem ipsum</h5>
            <h5>Lorem ipsum</h5>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12  MarginT10p  MarginB10p">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-right MarginT10p Absolute" style="right: 0; bottom: 0;">
